...
class File_recup:
    ...
    def __init__(self, msg_recu):
        dico = json.loads(msg_recu)
        ...
        self.json_formatted_string = msg_recu
        self.machine = GameServerConfig.get(GameServerConfig.nom == dico["Machine name"])  # recupère un record simple dans table
